  ...
  <div class="mains">
    ...
    <!--    <div class="mains_breadcrumb globalWith">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                ...
                <el-breadcrumb-item>Osake</el-breadcrumb-item>
...
/deep/ .el-carousel__item[data-v-39f87be5]:nth-child(2n) {
  background: #ffffff;
  border: 1px solid rgba(229, 229, 229, 0.7);
  box-shadow: 1px 1px 5px 1px rgba(52, 52, 52, 0.1);
  border-radius: 3px;
}

/deep/ .el-carousel__item[data-v-39f87be5]:nth-child(2n + 1) {
  background: #ffffff;
