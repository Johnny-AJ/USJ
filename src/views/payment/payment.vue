        ...
        <div class="payment_left">
            <div class="payment_content">
                ...
                <div class="payment_title">
                    Hello, little!
                    <div class="payment_you">Is this not you?</div>
                </div>
                ...
                <div class="payment_input">
                    <div>
                        <el-input placeholder="First Name" style="width: 220px;"></el-input>
                    </div>
                    <div>
                        <el-input placeholder="Family Name" style="width: 220px;"></el-input>
                    </div>
                </div>
                ...
                <div class="payment_Billing">
                    <el-input placeholder="The card number"></el-input>
                </div>
                ...
                <div class="payment_Valid">
                    <div>
                        ...
                        <div>
                            <el-input placeholder="MM/YY" style="width: 220px;"></el-input>
                        </div>
                    </div>
                    <div>
                        <div class="font_s">CSC</div>
                        <div>
                            <el-input placeholder="The last 3 digits" style="width: 220px;" suffix-icon="el-icon-bank-card"></el-input>
                        </div>
                    </div>
                </div>
...
.payment_title {
    ...
    font-family: SF Pro Text;
    font-weight: 400;
    color: rgba(13, 18, 21, 1);
    margin-bottom: 1.5rem;
    border-top: 1px solid #ffaaaaaa;
    padding-top: 1.75rem;
}
